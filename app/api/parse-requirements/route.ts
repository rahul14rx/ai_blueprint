      ...
      body: JSON.stringify({
        ...
        contents: [{
          ...
          parts: [{ text: [
            ...
            "For furnitureRequirements, return standard usable furniture for each requested room type. Bathroom: Bathtub, Toilet, Sink. Kitchen: Kitchen Counter, Refrigerator. Living: Couch, Carpet Area Rug, TV, TV Entertainment Console. Bedroom: Bed and Bedside Table. Dining: Dining Table and Dining Chair. Use width/depth in feet.",
