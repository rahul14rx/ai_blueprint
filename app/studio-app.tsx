...
import { AlertTriangle, ArrowLeft, Check, ChevronRight, Download, Home, RotateCcw, Ruler, Sparkles } from "lucide-react";
...
export default function StudioApp() {
  ...
  function generate() {
    ...
    setProject(createProject(brief)); setStage("plan");
  }
